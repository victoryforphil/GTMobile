export default function reducer(state={
  ...
  switch(action.type){
    ...
    case "FETCH_BELLS_FULFILLED" :{
      ...
      return {...state, bellList:{data: action.payload, fetched: false, fetching: false, error:null}}
    }
    ...
    case "FETCH_BELL_FULFILLED" :{
      ...
      return {...state, currentBell:{data: action.payload, fetched: false, fetching: false, error:null}}
    }
